...
const data = [
  {
    id: 1,
    title: "Always fresh & always hot & always tasteful",
    image: "/slide1.png",
  },
  {
    id: 2,
    title: "We deliver wherever you are in Sandton",
    image: "/slide2.png",
  },
  {
    id: 3,
...
const Slider = () => {
  ...
  return (
	...
	<button className="bg-red-500 text-white py-4 px-8 rounded-full">
	  Order Now
	</button>
      </div>
      {/* Image Container */}
